...
#' @details
#' \itemize{
#' \item q, omega: When q is set to integer, q vector will be generated by seq(0, 100, by = max(as.integer(100 / q), 1)) / 100 and omega will be assigned equal values correspondingly}
#'}
